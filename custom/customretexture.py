...
def manage_files():
    ...
    try:
        ...
        target_folders = ["0_vanilla", "1_bees_base", "2_bees_custom"]
    ...
    try:
        ...
        target_folders = ["0_vanilla", "3_goose_base", "4_goose_custom"]
    ...
    try:
        ...
        target_folders = ["0_vanilla", "3_goose_base", "4_goose_custom", "5_goose_face2"]
        destination_folder = "../DoL/setC/img"
